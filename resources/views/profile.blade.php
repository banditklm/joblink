                        ...
                        <!-- modal body -->
                            <div class="modal-body">
                                ...
                                <!-- tags-1 -->
                                    <div class="tags-1">
                                        <div class="imag">
                                            <a href="https://www.facebook.com/"><img src="{{asset('assets/photos/tips.jpg')}}" alt="photo de profile" class="img rounded-circle" width="100px" height="100px"></a>
                                        </div>
                                        <div class="desc">
                                            <h5>{{$user->name}}</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="champ1">
                                                            ...
                                                            <textarea class="form-control" name="info" id="info" cols="5" rows="3">{{$user->info}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <h4>Experience</h4>
